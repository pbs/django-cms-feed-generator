...
class ImageWidget(TextInput):
    ...
    def render(self, name, value, attrs=None):
        ...
        html_browse = '<a href="%s" class="related-lookup" id="lookup_id_image" title="Lookup" onclick="return showRSSImageLookupPopup(this, \'%s\', \'%s\');">' % (filer_url, image_input_id, getfile_url)
